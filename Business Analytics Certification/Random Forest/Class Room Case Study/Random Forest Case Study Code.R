...
importance(modelrf)
#The variable importance plot - sorted by MeanDecreaseGini
varImpPlot(modelrf)
...
##using diff k values (no of NNs) to see how they perform in terms of correct proportion of classification and success rate. 
